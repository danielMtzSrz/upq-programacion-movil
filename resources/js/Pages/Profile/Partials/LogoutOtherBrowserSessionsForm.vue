    ...
    <JetActionSection>
        ...
        <template #content>
            ...
            <div class="max-w-xl text-sm md:text-base">
                Si es necesario usted puede cerrar sesión en las sesiones activas en todos los demás dispositivos. Algunas de sus sesiones recientes están enlistadas debajo.
                Si siente que la seguridad de su cuenta está compromida le recomendamos actualizar su contraseña.
            </div>
            ...
            <JetDialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Por favor, ingrese su contraseña para confirmar que desea cerrar las sesiones activas en los demás navegadores.
                    <div class="mt-4">
                        <Password
