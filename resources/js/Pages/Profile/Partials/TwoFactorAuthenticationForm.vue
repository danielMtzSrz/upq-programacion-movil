        ...
        <template #content>
            ...
            <div class="mt-3 text-sm text-gray-600">
                <p class="text-sm md:text-base">
                    Cuando la autenticación de dos factores está habilitada, se le
                ...
                <div v-if="qrCode" class="row col-md-10 md:col-md-12 mx-auto">
                    <div class="text-sm col-md-8 m-auto px-0">
                        <p v-if="confirming" class="text-sm md:text-base mx-auto px-0">
                            Para terminar de habilitar la autenticación de dos factores, escanee
                        ...
                        <p v-else>
                            La autenticación de dos factores ahora está habilitada. Escanea el
                            siguiendo el código QR usando el autenticador de su teléfono
                            aplicación o introduzca la clave de configuración.
                        </p>
                    </div>
                        ...
                        <div class="col-sm-12 flex justify-end">
                            <div class="mt-4 w-full md:w-14rem">
                                <InputText
                                    ...
                                    @input="confirmationForm.code = $event"
